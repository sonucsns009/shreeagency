                            ...
                            <div class="tab-pane fade active show">
                                    <div class="row">
                                        <div class="col-sm-12">
											...
											<div class="form-group row">
                                                <label for="category_percentage" class="col-xl-3 col-md-4"> Description</label>
                                               <textarea name="category_description" id="category_description" class="form-control  col-md-6"></textarea>
                                            </div>
