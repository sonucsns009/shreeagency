			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
						...
						<div class="row">
							<div class="col-lg-12">
								<a class="btn btn-primary"  href="<?php echo base_url();?>Products/addProduct" style="float:right">Add Product</a>
							</div>
							</div>
						</div>	 
					</div>
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							?>>
													<a href="<?php echo base_url();?>Products/updateProduct/<?php echo base64_encode($product['id']);?>"><i data-feather="edit"></i></a>
													
													<a href="<?php echo base_url();?>Products/deleteProduct/<?php echo base64_encode($product['id']);?>" onclick="javascript:return chk_isDeleteComnfirm();">
