...
class Products extends CI_Controller {
	...
	public function index()
	{
		...
		$data['prodcnt']=$this->Products_model->getAllProducts(0,"","");
		...
		$config["total_rows"] =$data['prodcnt'];
		...
		$data['products']=$this->Products_model->getAllProducts(1,$config["per_page"],$page);
