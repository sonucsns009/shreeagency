			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
						...
						<div class="row">
							<div class="col-lg-12">
								<a class="btn btn-primary"  href="<?php echo base_url();?>Brands/addBrand" style="float:right">Add User</a>
							</div>
							</div>
						</div>	 
					</div>
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							?>>
													<a href="<?php echo base_url();?>Brands/updateBrand/<?php echo base64_encode($user['id']);?>"><i data-feather="edit"></i></a>
													
													<a href="<?php echo base_url();?>Brands/deleteBrand/<?php echo base64_encode($user['id']);?>" onclick="javascript:return chk_isDeleteComnfirm();">
