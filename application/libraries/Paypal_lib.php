...
class Paypal_lib 
{
	...
	function __construct()
	{
		...
		$this->add_field('quantity', '1');         $this->button('Pay Now!');     }      
		...
		echo $this->paypal_form('paypal_auto_form');         echo '</body></html>';     
		}
