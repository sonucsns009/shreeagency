			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
						...
						<div class="row">
							<div class="col-lg-12">
								<a class="btn btn-primary"  href="<?php echo base_url();?>Roles/addRole" style="float:right">Add Role</a>
							</div>
							</div>
						</div>	 
					</div>
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							?>>
													<a href="<?php echo base_url();?>Roles/updateRole/<?php echo base64_encode($role['id']);?>"><i data-feather="edit"></i></a>
													
													<a href="<?php echo base_url();?>Roles/deleteRole/<?php echo base64_encode($role['id']);?>" onclick="javascript:return chk_isDeleteComnfirm();">
